...
class LanguageSwitchController @Inject()(appConfig: AppConfig,
  ...
  override def fallbackURL: String = uk.gov.hmrc.incometaxsubscriptionselfemployedfrontend.controllers.individual.routes.InitialiseController.initialise.url
