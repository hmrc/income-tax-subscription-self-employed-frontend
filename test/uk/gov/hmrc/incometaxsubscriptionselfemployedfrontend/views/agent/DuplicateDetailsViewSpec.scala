...
import uk.gov.hmrc.incometaxsubscriptionselfemployedfrontend.views.html.agent.{DuplicateDetails => DuplicateDetailsView}
...
class DuplicateDetailsViewSpec extends ViewSpec {
  ...
  "DuplicateDetails" must {
    ...
    "has a bullet point list" which {
      ...
      "has a third bullet point with a link to add a new business" in {
        ...
        point.attr("href") mustBe appConfig.clientYourIncomeSourcesUrl
      }
    }
  ...
  object DuplicateDetailsMessages {
    ...
    object Options {
      ...
      val bulletThree: String = "go to your client’s income sources"
    }
  }
