...
package uk.gov.hmrc.incometaxsubscriptionselfemployedfrontend.views.mocks.individual
...
trait MockBusinessListCYA extends PlaySpec with MockitoSugar with BeforeAndAfterEach {
  ...
  def mockCheckYourAnswers(): Unit = {
    when(checkYourAnswers(any(), any(), any())(any(), any())) thenReturn HtmlFormat.empty
  }
