...
class AddressLookupRoutingControllerSpec extends ControllerBaseSpec
  with MockAddressLookupConnector with MockIncomeTaxSubscriptionConnector {
  ...
  "addressLookupRedirect" should {
    ...
    "return 303, SEE_OTHER)" when {
      "the address lookup service returns valid data" in {
        ...
        mockSaveSelfEmployments(addressIdKey, testValidBusinessAddressModel)(Right(PostSelfEmploymentsSuccessResponse))
