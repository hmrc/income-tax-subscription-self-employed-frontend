...
import uk.gov.hmrc.incometaxsubscriptionselfemployedfrontend.forms.submapping.DateMapping
import uk.gov.hmrc.incometaxsubscriptionselfemployedfrontend.forms.validation.testutils.DataMap.DataMap
import uk.gov.hmrc.incometaxsubscriptionselfemployedfrontend.models.{DateModel, PropertyCommencementDateModel}

class PropertyCommencementDateFormSpec extends PlaySpec with GuiceOneAppPerSuite {

  import DateMapping._
  import uk.gov.hmrc.incometaxsubscriptionselfemployedfrontend.forms.PropertyCommencementDateForm._
  ...
  "The PropertyCommencementDateForm" should {
    ...
    "when testing the validation" should {
      "output the appropriate error messages for the start date" when {
        ...
        val afterMax = "error.property_accounting_period.minStartDate"
