  ...
  "businessNameConfirmationForm" must {
    ...
    "produce a form error" when {
      "there was no data provided to the binding form" in {
        ...
        emptyForm.errors.headOption mustBe Some(FormError(fieldName, "error.individual.business-name-confirmation.empty"))
      }
      "there was an invalid value provided to the binding form" in {
        ...
        invalidForm.errors.headOption mustBe Some(FormError(fieldName, "error.individual.business-name-confirmation.empty"))
      }
    }
  }
