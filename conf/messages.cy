...
business.accounting-method.accordion                            = Help gyda dulliau cyfrifyddu
business.accounting-method.accordion.subheading                 = Enghraifft
...
business.accounting-method.cash.label                           = Cyfrifyddu ar sail arian parod
business.accounting-method.cash.hint                            = Rydych yn cofnodi naill ai ar y dyddiad yr ydych yn cael taliad gan eich tenantiaid i mewn i’ch cyfrif banc, neu ar y dyddiad yr ydych yn talu bil, er enghraifft ar gyfer atgyweirio a chynnal a chadw. Mae’r rhan fwyaf o fusnesau bach yn defnyddio’r dull hwn.
business.accounting-method.accruals                             = <span class="heading-small">Cyfrifyddu traddodiadol</span><br>Rydych yn cofnodi ar y dyddiad yr ydych yn anfon anfoneb at eich tenantiaid, neu’n gofyn am daliad ganddynt, hyd yn oed os nad ydych yn cael nac yn talu unrhyw arian. Rydych yn cofnodi ar y dyddiad yr ydych yn cael anfoneb ar gyfer atgyweirio neu gynnal a chadw. Mae hwn hefyd yn cael ei alw yn ‘cyfrifyddu croniadau’ neu ‘cyfrifyddu traddodiadol’.
business.accounting-method.accruals.label                       = Cyfrifyddu traddodiadol
business.accounting-method.accruals.hint                        = Rydych yn cofnodi ar y dyddiad yr ydych yn anfon anfoneb at eich tenantiaid, neu’n gofyn am daliad ganddynt, hyd yn oed os nad ydych yn cael nac yn talu unrhyw arian. Rydych yn cofnodi ar y dyddiad yr ydych yn cael anfoneb ar gyfer atgyweirio neu gynnal a chadw. Mae hyn hefyd yn cael ei alw’n gyfrifyddu  ‘ar sail croniadau‘ neu’n gyfrifyddu ’safonol’.
...
error.business-accounting-method.empty                          = Dewiswch os ydych yn defnyddio cyfrifyddu ar sail arian parod neu cyfrifyddu traddodiadol.
...
agent.self-employed-cya.accounting-method.cash                  = Cyfrifyddu ar sail arian parod
agent.self-employed-cya.accounting-method.accruals              = Cyfrifyddu traddodiadol
...
agent.full-income-source.name.hint                                   = Dyma enw’r busnes a ddefnyddioch i gofrestru ar gyfer Hunanasesiad.<br>Os nad oes enw ar eich busnes, nodwch eich enw llawn.
agent.full-income-source.start-date.legend                           = Pryd y dechreuodd busnes eich cleient fasnachu?
agent.full-income-source.start-date.hint                             = Byddwn yn defnyddio’r dyddiad hwn i gyfrifo unrhyw daliadau Yswiriant Gwladol Dosbarth 2.<br>Er enghraifft, 17 8 2014
agent.full-income-source.start-date-before-limit.legend              = A oedd y busnes hwn wedi dechrau cyn 6 Ebrill {0}?
agent.full-income-source.accounting-method.legend                    = Pa ddull cyfrifo y mae’ch cleient yn ei ddefnyddio ar gyfer ei fusnes hunangyflogedig?
agent.full-income-source.accounting-method.hint                      = Rhaid i bob busnes masnachwr unigol eich cleient ddefnyddio’r un dull cyfrifyddu.
agent.full-income-source.accounting-method.details.summary           = Help gyda dull cyfrifyddu
agent.full-income-source.accounting-method.details.para-one          = Enghraifft
agent.full-income-source.accounting-method.details.para-two          = Creodd eich cleient anfoneb i rywun ym mis Mawrth 2024, ond ni dderbyniodd yr arian tan fis Mai 2024. Os ydych yn rhoi gwybod i CThEF eich cleient wedi cael yr incwm hwn ym:
agent.full-income-source.accounting-method.details.bullet-one        = mis Mai 2024, mae eich cleient yn defnyddio cyfrifyddu ar sail arian parod
agent.full-income-source.accounting-method.details.bullet-two        = mis Mawrth 2024, mae eich cleient yn defnyddio cyfrifyddu traddodiadol
agent.full-income-source.accounting-method.cash                      = Cyfrifyddu ar sail arian parod
agent.full-income-source.accounting-method.accruals                  = Cyfrifyddu traddodiadol
agent.error.full-income-source.business-trade.empty                  = Nodwch fasnach busnes eich cleient
...
agent.error.full-income-source.start-date.year.empty                 = Mae’n rhaid i’r dyddiad gynnwys blwyddyn
agent.error.full-income-source.start-date.day-month.empty            = Mae’n rhaid i’r dyddiad gynnwys diwrnod a mis
agent.error.full-income-source.start-date.day-year.empty             = Mae’n rhaid i’r dyddiad gynnwys diwrnod a blwyddyn
agent.error.full-income-source.start-date.month-year.empty           = Mae’n rhaid i’r dyddiad gynnwys mis a blwyddyn
agent.error.full-income-source.start-date.day-month-year.max-date    = Ni all y dyddiad fod yn fwy na 7 diwrnod yn y dyfodol
agent.error.full-income-source.start-date.day-month-year.min-date    = Mae’n rhaid i’r dyddiad y dechreuodd busnes eich cleient fod ar neu ar ôl <span class="govuk-nowrap">{0}</span>
agent.error.full-income-source.start-date.day-month-year.invalid     = Rhaid i’r dyddiad fod yn ddyddiad go iawn
agent.error.full-income-source.start-date.day.invalid                = Rhaid i’r dyddiad fod yn ddyddiad go iawn
agent.error.full-income-source.start-date.month.invalid              = Rhaid i’r dyddiad fod yn ddyddiad go iawn
agent.error.full-income-source.start-date.year.invalid               = Rhaid i’r dyddiad fod yn ddyddiad go iawn
agent.error.full-income-source.start-date.day-month.invalid          = Rhaid i’r dyddiad fod yn ddyddiad go iawn
agent.error.full-income-source.start-date.day-year.invalid           = Rhaid i’r dyddiad fod yn ddyddiad go iawn
...
agent.error.full-income-source.accounting-method.invalid             = Dewiswch a yw’ch cleient yn defnyddio cyfrifyddu ar sail arian parod neu gyfrifyddu traddodiadol
