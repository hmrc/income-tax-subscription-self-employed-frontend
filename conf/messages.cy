...
base.user-research.title                                         = Helpu i wella ein gwasanaeth
base.user-research.link                                          = Atebwch ychydig o gwestiynau am eich hunan er mwyn ymuno â’r panel ymchwil
base.change                                                     = Newid
base.yes                                                        = Iawn
base.no                                                         = Na
base.add                                                        = Ychwanegu
...
##service name
individual-service-name                                          = Defnyddio meddalwedd i anfon diweddariadau Treth Incwm
agent-service-name                                               = Defnyddiwch feddalwedd i roi gwybod am Dreth Incwm eich cleient
...
check-your-answers.heading                                      = Gwiriwch eich atebion
check-your-answers.sub-heading                                  = Busnes {0}
check-your-answers.trading-start-date                           = Dyddiad dechrau masnachu’r busnes
check-your-answers.trading-start-date.change                    = Newid dyddiad dechrau masnachu’r busnes
check-your-answers.business-name                                = Enw’r busnes
check-your-answers.business-name.change                         = Newid enw’r busnes
check-your-answers.business-trade                               = Masnach y busnes
check-your-answers.business-trade.change                        = Newid masnach y busnes
check-your-answers.business-address                             = Cyfeiriad y busnes
check-your-answers.business-address.change                      = Newid cyfeiriad y busnes
check-your-answers.remove-business                              = Dileu busnes {0}
check-your-answers.add-another-business-heading                 = A hoffech ychwanegu busnes unig fasnachwr arall?

# Check your answers add another business
error.add-another-business.limit-reached                        = Gallwch ychwanegu hyd at {0} o fusnesau yn unig.
error.add-another-business.invalid                              = Dewiswch ‘Iawn’ os ydych am ychwanegu busnes unig fasnachwr arall.
error.add-another-business.empty                                = Dewiswch ‘Iawn’ os ydych am ychwanegu busnes unig fasnachwr arall.
...
# Check your answers
agent.check-your-answers.title                                  = Gwiriwch eich atebion
agent.check-your-answers.heading                                = Gwiriwch eich atebion
agent.check-your-answers.sub-heading                            = Busnes {0}
agent.check-your-answers.trading-start-date                     = Dyddiad dechrau masnachu’r busnes
agent.check-your-answers.trading-start-date.change              = Newid dyddiad dechrau masnachu’r busnes
agent.check-your-answers.business-name                          = Enw’r busnes
agent.check-your-answers.business-name.change                   = Newid enw’r busnes
agent.check-your-answers.business-trade                         = Masnach y busnes
agent.check-your-answers.business-trade.change                  = Newid masnach y busnes
agent.check-your-answers.business-address                       = Cyfeiriad y busnes
agent.check-your-answers.business-address.change                = Newid cyfeiriad y busnes
agent.check-your-answers.remove-business                        = Dileu busnes {0}
agent.check-your-answers.add-another-business-heading           = A hoffech ychwanegu busnes unig fasnachwr arall?

# Agent Check your answers add another business
agent.error.add-another-business.limit-reached                  = Gallwch ychwanegu hyd at {0} o fusnesau yn unig.
agent.error.add-another-business.invalid                        = Dewiswch ‘Iawn’ os ydych am ychwanegu busnes unig fasnachwr arall.
agent.error.add-another-business.empty                          = Dewiswch ‘Iawn’ os ydych am ychwanegu busnes unig fasnachwr arall.
