    ...
    "an agent times out" should {
      "redirect and sign out the user" in {
        ...
        res must have(
          ...
          redirectURI("http://localhost:9025/gg/sign-in?continue=http%3A%2F%2Flocalhost%3A9561%2Freport-quarterly%2Fincome-and-expenses%2Fsign-up%2Fclient&origin=income-tax-subscription-self-employed-frontend")
        )
      }
    }
  }
